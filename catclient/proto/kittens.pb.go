...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_kittens_b2bee55d4607b772, []int{0}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_kittens_b2bee55d4607b772, []int{1}
}
...
func (c *kittensClient) Hello(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/bmigo.grpc.Kittens/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("kittens.proto", fileDescriptor_kittens_b2bee55d4607b772) }

var fileDescriptor_kittens_b2bee55d4607b772 = []byte{
